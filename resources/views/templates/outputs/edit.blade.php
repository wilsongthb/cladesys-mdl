            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                    <div class="form-group" title="[cantidad] Nombre">
                        ...
                        <select ng-model="det.fila.input_details_id" class="form-control" ng-change="det.getRealPriceId(det.fila.input_details_id)">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                    ...
                    <input type="number" ng-model="det.fila.quantity" class="form-control" required>
                </div>
