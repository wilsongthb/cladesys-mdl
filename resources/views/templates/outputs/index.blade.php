        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr ng-repeat="d in resource.data.data">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="@{{config.editUrl}}/@{{d.id}}" class="btn btn-default"><i class="fa fa-pencil"></i> </a>
                            <a ng-if="d.status === 1" ng-click="resource.delete(d.id)" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                        </div>
                    </td>
                </tr>
            </tbody>
